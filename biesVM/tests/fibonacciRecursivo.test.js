import antlr4 from 'antlr4'; // Importa la biblioteca ANTLR para la manipulación de lenguajes.
import BiesVMLexer from '../src/Grammar/BiesVMLexer.js'; // Asegúrate de que la ruta sea correcta para el lexer de BiesVM.
